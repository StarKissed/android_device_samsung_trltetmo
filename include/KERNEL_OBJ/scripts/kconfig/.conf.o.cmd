cmd_scripts/kconfig/conf.o := gcc -Wp,-MD,scripts/kconfig/.conf.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -DCURSES_LOC="<ncurses.h>" -DLOCALE -DKBUILD_NO_NLS  -c -o scripts/kconfig/conf.o scripts/kconfig/conf.c
...
deps_scripts/kconfig/conf.o := \
  ...
  /opt/local/lib/gcc48/gcc/x86_64-apple-darwin13/4.8.3/include/stdint.h \
  /opt/local/lib/gcc48/gcc/x86_64-apple-darwin13/4.8.3/include-fixed/stdint.h \
  ...
  /opt/local/lib/gcc48/gcc/x86_64-apple-darwin13/4.8.3/include/stdbool.h \
  scripts/kconfig/lkc_proto.h \
  /opt/local/lib/gcc48/gcc/x86_64-apple-darwin13/4.8.3/include/stdarg.h \
